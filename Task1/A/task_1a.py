...
# Team ID:			2527
# Author List:		Shubham Sarkar, Aditya Gajjar
# Filename:			task_1a.py
# Functions:	    `identify_features_and_targets`, `load_as_tensors`, `data_preprocessing`
...
def data_preprocessing(task_1a_dataframe):
	...
	scaler = MinMaxScaler()
	encoded_dataframe = pandas.DataFrame(scaler.fit_transform(encoded_dataframe), columns=encoded_dataframe.columns)
	##########################################################
...
def training_function(model, number_of_epochs, tensors_and_iterable_training_data, loss_function, optimizer):
	...
	'''	
	#################	ADD YOUR CODE HERE	##################
	x_train, x_test, y_train, y_test = tensors_and_iterable_training_data[:-1:]

	best_acc = - numpy.inf   # init to negative infinity
	best_weights = None
...
def validation_function(trained_model, tensors_and_iterable_training_data):
	...
	'''	
	#################	ADD YOUR CODE HERE	##################
	x_test, y_test = tensors_and_iterable_training_data[1], tensors_and_iterable_training_data[3]
	trained_model.eval()
	correct=0
	total=0
