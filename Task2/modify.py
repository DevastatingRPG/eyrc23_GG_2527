...
def detect_ArUco_details(image):
    ...
    * ArUco_corners = 
    ...
    ##############	ADD YOUR CODE HERE	##############
    # Load ArUco dictionary and initialize the detector
